...
# print(sally.responkse(human_message))

boredChatbot = BoredChatbot("ChatBot")
human_message = input(boredChatbot.greeting())
print(boredChatbot.response(human_message))
